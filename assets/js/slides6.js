...
*/
  ...
  $.fn.slidesDialog = function( options ) {
    ...
    function mergeSettings(el){
      // default settings
      var settings = {
        template:'<div class="dialog hidden"><div class="close" data-dialog-action="close"></div><div class="dialogContent"><div class="text opacity-8">This popup was created with javascript. This is the default templateEngine. You can provide HTML code in the "templateEngine" property and it will be used as a Dialog box HTML.</div></div><ul><li data-dialog-action="close" class="indigo">Nice!</li></ul></div>', // the HTML code of a dialog box
